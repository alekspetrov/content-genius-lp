...
export const SITE_URL = "https://contentgenius.io";
export const SITE_TITLE = "Content Genius";
export const SITE_OG_IMAGE_URL = "https://contentgenius.io/og_default_img.png";
