...
image:
  {
    src: "/blog/prompt-framework-vs-prompts-collection/cover.png",
    alt: "Prompt Framework vs. Prompts Collection illustration",
  }
openGraph:
...
<div class="bg-gray-800 px-8 border rounded-lg prose-p:text-gray-300 prose-strong:text-white mb-8">
**_Tech Blogger_**
